...
func (sb *Backend) Commit(proposal istanbul.Proposal, aggregatedSeal types.IstanbulAggregatedSeal, aggregatedEpochValidatorSetSeal types.IstanbulEpochValidatorSetSeal) error {
	...
	printHeader := func() { fmt.Println("blockNumber,txCount,usedGas,round,sleep,verify,ibft,consensus,cycle") }
	...
	fmt.Printf("%v,%v,%v,%v,%v,%v,%v,%v,%v\n",
		...
		block.GasUsed(), round, istanbul.SleepTime.Nanoseconds(), istanbul.VerifyTime.Nanoseconds(), ibft.Nanoseconds(), (ibft - istanbul.VerifyTime).Nanoseconds(), cycle.Nanoseconds())
